...
map("n", "<leader>x", function()
  ...
  vim.api.nvim_feedkeys(":%s/" .. vim.fn.escape(word, "/\\") .. "//gc" .. string.rep(vim.api.nvim_replace_termcodes("<Left>", true, false, true), 3), "n", false)
...
map("n", "<leader>g[", "ciw[]<C-[>P", "Surround word with []; Normal")
map("n", "<leader>g{", "ciw{}<C-[>P", "Surround word with {}; Normal")
map("n", '<leader>g"', 'ciw""<C-[>Pla', 'Surround word with ""; Normal')
map("n", "<leader>g'", "ciw''<C-[>Pla", "Surround word with ''; Normal")
map("n", "<leader>g*", "ciw**<C-[>Pla", "Surround word with **; Normal")
map("n", "<leader>g<", "ciw<><C-[>P", "Surround word with <>; Normal")
...
map("v", "<leader>g[", "c[]<C-[>P", "Surround word with []; Visual")
map("v", "<leader>g{", "c{}<C-[>P", "Surround word with {}; Visual")
map("v", '<leader>g"', 'c""<C-[>Pla', 'Surround word with ""; Visual')
map("v", "<leader>g'", "c''<C-[>Pla", "Surround word with ''; Visual")
map("v", "<leader>g*", "c**<C-[>Pla", "Surround word with **; Visual")

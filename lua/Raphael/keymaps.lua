...
function M.setup(core)
  ...
  vim.keymap.set("n", leader .. "r", function() vim.notify("Next theme TBD") end, { desc = "Next theme" })
  vim.keymap.set("n", leader .. "R", function() vim.notify("Previous theme TBD") end, { desc = "Previous theme" })

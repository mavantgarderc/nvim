...
M.cycle_previous = function(...)
  return modules.cycler and modules.cycler.cycle_previous and
      modules.cycler.cycle_previous(...)
end
M.apply_colorscheme = function(...)
  return modules.loader and modules.loader.apply_colorscheme and
      modules.loader.apply_colorscheme(...)
end
M.preview_colorscheme = function(...)
  return modules.preview and modules.preview.preview_colorscheme and
      modules.preview.preview_colorscheme(...)
end
M.get_current_colorscheme = function(...)
  return modules.loader and modules.loader.get_current_colorscheme and
      modules.loader.get_current_colorscheme(...)
end
M.get_all_colorschemes = function(...)
  return modules.colors and modules.colors.get_all_colorschemes and
      modules.colors.get_all_colorschemes(...)
end
